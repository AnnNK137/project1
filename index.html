    ...
    <div class="hp_main_content" >
        ...
        <section class="hp_brand_info hp_stat row evenly_spacing" id="hp_stat_box">
            ...
            <figure class="hp_stat_group row flex_center" >
                <img class="hp_icons" src="images/clock.png" alt="icons clock">
            ...
            <!-- PROJECT DELIVERED -->
            <figure class="hp_stat_group row flex_center" >
                <img class="hp_icons" src="images/project.png" alt="icons project">
                <figcaption class="hp_stat_content">
            ...
            <!-- HAPPY CLIENTS -->
            <figure class="hp_stat_group row flex_center" >
                <img class="hp_icons" src="images/heart.png" alt="icons heart">
                    <figcaption class="hp_stat_content">
                    <h4>Happy clients</h4>
                    <h2>30+</h2>
                </figcaption>
        ...
        <section class="hp_brand_info" id="hp_about">
            ...
            <figure id="hp_samples" class="flex_center center">
                <img src="images/sample/sample1.jpg" alt="Samples 1">
                <img src="images/sample/sample2.jpg" alt="Samples 2">
                <img src="images/sample/sample3.jpg" alt="Samples 3">
                <img src="images/sample/sample4.jpg" alt="Samples 4">
                <img src="images/sample/sample5.jpg" alt="Samples 5">
                <img src="images/sample/sample6.jpg" alt="Samples 6">
            </figure>
            ...
            <article class="hp_desc colum"> <!-- Description -->
                ...
                <div id="hp_values_list" class="hp_list">
                    ...
                    <section class="hp_values colum flex_center center">
                        <img class="hp_icons" src="images/innovative.png" alt="icons light">
                        <h2>Innovation</h2>
                    ...
                    <section class="hp_values colum flex_center center">
                        <img class="hp_icons" src="images/pin.png" alt="icons pin">
                    ...
                    <section class="hp_values colum flex_center center">
                        <img class="hp_icons" src="images/diamond.png" alt="icons diamond">
                        <h2>Quality First</h2>
                        <p class="hp_value_desc">
                    ...
                    <section class="hp_values colum flex_center center">
                        <img class="hp_icons" src="images/collab.png" alt="icons people">
                        <h2>Collaboration</h2>
                        <p class="hp_value_desc">
                    ...
                    <section class="hp_values colum flex_center center">
                        <img class="hp_icons" src="images/task.png" alt="icons task">
                    ...
                    <!-- VALUES: COLLABORATION -->
                    <section class="hp_values colum flex_center center">
                        <img class="hp_icons" src="images/art.png" alt="icons art">
                        <h2>Creativity</h2>
                        <p class="hp_value_desc">
        ...
        <section class="hp_brand_info" id="hp_vacancies">
            ...
            <section class="hp_brand_info center">
                ...
                <div id="hp_vacancies_list" class="hp_list colum flex_center">
                    ...
                    <section class="hp_vacancies row">
                        <figure class="colum flex_center">
                            <img src="images/CODER.jpg" alt="job 2">
                            <br>
                            <figcaption>
                    ...
                    <section class="hp_vacancies row">
                        <figure class="colum flex_center">
                            <img src="images/CLOUD.jpg" alt="job 3">
                            <br>
                            <figcaption>
        ...
        <div class="footer_details">
            <section class="colum"> <!-- Contact -->
                ...
                <ul>
                    ...
                    <li>Github Repo: <a href="https://github.com/AnnNK137/project1">3Ners Project 1</a></li>                
                </ul>
            </section>
