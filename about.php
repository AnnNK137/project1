         ...
         <nav>
            <a href="index.html" class="brand_logo">
             ...
             <ul class="nav_items">
                ...
                <li><a class="nav_current" href="about.html">About</a></li>
             </ul>
         </nav>
     </header>
        ...
        <div class="ap_member_details row flex_center">
            ...
            <!-- desc -->
                <div class="ap_members_desc colum flex_center">
                    <figure>
                    <img src="images/member_potrait_example.png" alt="member_picture 1">
                    </figure>
            ...
            <section class="ap_members colum">
                ...
                <div class="ap_members_desc colum flex_center">
                    <figure>
                    <img src="images/member_potrait_example.png" alt="member_picture 2">
                    </figure>
                    <section class="ap_member_details">
                    <h3>Student information</h3>
                    <ul>
            ...
            <section class="ap_members colum">
                ...
                <div class="ap_members_desc colum flex_center">
                    <figure>
                    <img src="images/member_potrait_example.png" alt="member_picture 3">
                    </figure>
                    <section class="ap_member_details">
                    <h3>Student information</h3>
                    <ul>
